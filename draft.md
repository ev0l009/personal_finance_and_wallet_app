...
- **During Data Loading:** Strings representing timestamps (e.g., `"2026-09-23T10:00:00Z"`) are parsed using datetime.fromisoformat() to prepare them for math logic operations. 
